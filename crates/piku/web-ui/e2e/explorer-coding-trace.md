...
page errors from sandboxed `about:srcdoc` preview errors, intentional rejected
requests, and evaluator-generated noise. An aggregate console count alone cannot
support a finding.
